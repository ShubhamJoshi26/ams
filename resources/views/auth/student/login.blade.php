        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    {{-- <img src="/assets/img/illustrations/auth-login-illustration-light.png" alt="auth-login-cover"
                        ...
                        <img src="/assets/img/illustrations/login.avif" alt="auth-login-cover"
                        class="my-5 auth-illustration"
                        data-app-light-img="illustrations/login.avif"
                        data-app-dark-img="illustrations/auth-login-illustration-dark.html">
            ...
            <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
                <div class="w-px-400 mx-auto mt-12 pt-5">
                    <h4 class="mb-1">Welcome to LMS! 👋</h4>
                    ...
                    @foreach ($errors->all() as $error)
                        <li>{{ $error }}</li>
                    @endforeach
                    <form id="" class="mb-6" action="{{ route('student.login') }}" method="POST">
                        @csrf
                        <div class="mb-6">
