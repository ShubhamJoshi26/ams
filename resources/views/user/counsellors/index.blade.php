      ...
      dt_permission = dataTablePermissions.DataTable({
        ...
        columnDefs: [
...

          {
            ...
            render: function (data, type, full, meta) {
              return (
                '<span class="text-nowrap"><button class="btn btn-sm btn-icon me-2" onclick="allot(&#39;/users/counsellors/allot-university/' + full['id'] + '&#39, &#39;modal-md&#39;)"><i class="ti ti-plus"></i></button>'+
                '<button class="btn btn-sm btn-icon me-2" onclick="edit(&#39;/users/counsellors/edit/' + full['id'] + '&#39, &#39;modal-lg&#39;)"><i class="ti ti-edit"></i></button>' +
                '<button onclick="destry(&#39;/users/counsellors/destroy/' + full['id'] + '&#39, &#39;users-table&#39;)" class="btn btn-sm btn-icon delete-record"><i class="ti ti-trash"></i></button></span>'
              );
            }
          }
        ],
  ...
  <div class="col-md-6">
    <div class="dt-buttons btn-group flex-wrap" style="float:right">
      <button class="btn add-new btn-primary mb-3 mb-md-0 waves-effect waves-light" tabindex="0"
        aria-controls="users-table" type="button" onclick="add('{{ route('counsellors.create') }}', 'modal-lg')">
        <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Counsellor </span>
      </button>
    </div>
  </div>
</div>
