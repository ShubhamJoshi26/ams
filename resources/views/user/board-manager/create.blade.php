<div class="modal-body">
  ...
  <div class="text-center mb-6">
    <h4 class="mb-2">Add Board Manager</h4>
  </div>
  <form id="addBoardManager" class="row g-6" action="{{ route('board-manager.store') }}" method="post">
...
<script>
  ...
  $("#addBoardManager").submit(function (e) {
    e.preventDefault();
    if ($("#addBoardManager").valid()) {
