<div class="modal-body">
    ...
    <form id="student-form" action="{{ route('student.update.profile', $student->id) }}" method="POST" class="row g-3">
        @csrf
        {{-- @method('PUT') --}}
            ...
            <div class="card p-3 shadow-sm">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="heighest_qualification" name="highest_qualification"
                            class="form-control"
