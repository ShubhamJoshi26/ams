...
<div class="container mt-4">
    <div class="row">
            ...
            <div class="row g-3 mb-5">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="stats-card">
                        <div class="stats-value">{{count($studentOtherData->data->on_going_courses)}}</div>
                        <div class="stats-label">In Progress</div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="stats-card">
                        <div class="stats-value">{{count($studentOtherData->data->completed_courses)}}</div>
            ...
            <ul class="nav nav-pills mb-4" id="courseTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="in-progress-tab" data-bs-toggle="pill"
            ...
            <div class="tab-content" id="courseTabsContent">
                ...
                <div class="tab-pane fade show active" id="in-progress" role="tabpanel">
                    <div class="section-header">
                        ...
                        <span class="text-muted small">3 courses</span>
                    </div>
                ...
                <div class="tab-pane fade" id="completed" role="tabpanel">
                    <div class="section-header">
                        ...
                        <span class="text-muted small">5 courses</span>
                    </div>

                    <!-- Completed Course Card -->
                    <div class="course-card">
                        <div class="d-flex gap-3 align-items-start">
                            <img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=400&h=400&fit=crop"
                                alt="Teaching Basics" class="course-image">

                            <div class="flex-fill">
                                <h3 class="course-title">Teaching Basics</h3>
                                <div class="course-meta mb-2">
                                    <span>4 Months</span>
                                    <span class="mx-2">•</span>
                                    <span>24/24 Lessons</span>
                                </div>
                                <p class="text-muted small mb-0">Completed on Aug 12</p>
                            </div>
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-3 align-items-lg-center course-actions">
                                <div class="d-flex flex-column gap-2" style="min-width: 280px;">
                                    ...
                                    <span class="badge badge-success align-self-end">Certificate</span>
                                </div>

                                <div class="d-flex gap-2">
                                    <button class="btn btn-outline-primary">Syllabus</button>
                                    <button class="btn btn-primary">Certificate</button>
                                    <button class="btn btn-outline-secondary">Retake</button>
                                </div>
                            </div>
                        </div>
                    </div>
