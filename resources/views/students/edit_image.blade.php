<div class="modal-body">
    ...
    <form id="student-form" action="{{ route('student.update.image', auth('student')->user()->id) }}" method="POST" class="row g-3">
        @csrf
        {{-- @method('PUT') --}}
        ...
        <div class="col-12">
            <div class="card p-3 shadow-sm">
                ...
                <div class="row">
                    ...
                    <!--  Image -->
                    <div class="col-md-6">
                        <label for="edit-image" class="form-label">Photo</label>
                        <input type="file" name="image" id="edit-image" class="form-control">
                        <div class="mt-2">
                            <img id="edit-image-preview" src="{{ asset(auth('student')->user()->image) }}" alt="News Image"
